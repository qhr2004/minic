...
std::vector<std::string> IRGenerator::generate(const Program& program) {
    instructions_.clear();
    tempCounter_ = 0;
    labelCounter_ = 0;
...
const std::vector<std::string>& IRGenerator::instructions() const {
    return instructions_;
}

void IRGenerator::print(std::ostream& os) const {
